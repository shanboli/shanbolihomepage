...
Rum 0738            & \textit{Tel:} +46 704646157 (SE) \textbar\space +86 13810559910 (CN)\\
Hanstav\"{a}gen 51           & \textit{E-mail:}\href{mailto:shanboli@gmail.com}{shanboli@gmail.com}\\
164 53 Kista, Sweden    &\textit{Homepage:}\href{http://www.isk.kth.se/~shanbo/}{http://www.isk.kth.se/\textasciitilde shanbo}\\
\end{tabular}
...
\href{http://code.google.com/p/jxchat2/}{\textbf{JXChat2}} 
\begin{outerlist}
\item \texttt{Description:}
JXChat2 is a p2p application based on JXTA. It implements sending messages between two peers and also it could transfer files between two peers. 
\item \texttt{API/Framework:}
Java, JXTA, Swing
\item \texttt{Homepage:}
\href{http://code.google.com/p/jxchat2/}{http://code.google.com/p/jxchat2/}
\end{outerlist}
...
{\textbf{Good at Written and Spoken English }}\\
...
Hibernate, EJB3, Spring2.5, JSF, Struts, Swing, Log4j, JUnit4 
...
XHTML, XHTML MP, HTML, CSS, Javascript, JSON, d\={o}j\={o}, AJAX, JSP, JSF, XML,\\ Ruby \nobreak on \nobreak Rails, PHP 

\blankline

{\textbf{Application Server:}}\\
Apache Tomcat, Glassfish, JBoss, WebSphere, Apache HTTP Server
...
\begin{itemize}
\item Peter Yeung \\ Chief Strategist - Strategy \& Development \\Ericsson Developer Connection\\ Ericsson AB, Sweden \\
  +46 (0)1071 36652\\
...
\end{itemize}
\begin{itemize}
\item Xudong Chen \\ Senior Engineer \\ School of Software \\ Beijing Jiaotong University, China \\
  +86 (0)10-51683818 \\
  \href{mailto:chenxd@bjtu.edu.cn}{\tt chenxd@bjtu.edu.cn} 
\end{itemize}
\begin{itemize}
\item Fengjuan Feng \\ Senior Engineer \\ School of Software \\ Beijing Jiaotong University, China \\
  +86 (0)10-51683818 \\
  \href{mailto:fjfeng@bjtu.edu.cn}{\tt fjfeng@bjtu.edu.cn} \vspace{2in}
\end{itemize}
\end{minipage}

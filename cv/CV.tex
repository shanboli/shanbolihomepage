...
\href{http://code.google.com/p/scallope/}{\textbf{Scallope}} \hfill \textbf{October 2008 to December 2008}
\begin{outerlist}
...
\begin{outerlist}
\item \texttt{Description:}
A resource management system for advertisment company, which is Developed with Extreme Programming.
\item \texttt{API/Framework:}
Ruby on Rails, MySQL
\end{outerlist}
...
\end{itemize}
\begin{itemize}
\item Nima Dokoohaki \\ Junior Researcher  \\ Royal Institute of Technology (KTH), Sweden \\
  +46 8 790 4149 \\
  \href{mailto:nimad@kth.se}{\tt nimad@kth.se}
\end{itemize}
\end{minipage}
